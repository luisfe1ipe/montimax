    ...
    <div class="container-sm" style="padding-top: 5%">
        ...
        <form action="{{ route('projeto.update', $projeto->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="pt-3">
                ...
                <input type="file" class="form-control"  name="img_secundaria" value="{{ $projeto->img_secundaria }}">
            </div>

            <div class="data">
                <div class="inicio">
                    <label for="data_inicio">Data Inicio</label>
                    <input type="date" class="form-control" name="data_inicio" id="" value="{{ $projeto->data_inicio }}">
                </div>
                <div class="termino">
                    <label for="data_final">Data Final</label>
                    <input type="date" class="form-control" name="data_final" id=""  value="{{ $projeto->data_final }}">
                </div>
            </div>
